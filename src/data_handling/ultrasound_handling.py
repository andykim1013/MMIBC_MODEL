...
BUSI_ORIGINAL_PATH = r"C:\Users\konyang\Desktop\MMIBC-main\data\ultrasound"
BUSI_IMAGES_PATH = os.path.join(BUSI_ORIGINAL_PATH, 'images')
BUSI_MASKS_PATH = os.path.join(BUSI_ORIGINAL_PATH, 'masks')

ORGANIZED_DATASET_BASE_PATH = r"C:\Users\konyang\Desktop\MMIBC-main\mmibc\ultrasound"
ORGANIZED_METADATA_FILE = os.path.join(ORGANIZED_DATASET_BASE_PATH, 'busi_metadata.csv')

...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\saved_models\best_multimodal_model_roi_ce_margin030_bs4_seed42.pth",
    )

    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\runs\roi_fusion\roi_margin030_threshold_seed42",
    )

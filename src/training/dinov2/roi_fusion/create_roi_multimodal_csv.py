...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_csv",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\mmibc\multimodal_pairs_no_mammo_leak.csv",
    )

    parser.add_argument(
        "--output_csv",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\mmibc\multimodal_pairs_roi_no_mammo_leak.csv",
    )

    parser.add_argument(
        "--roi_root",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\mmibc\ultrasound_roi\images",
    )

    parser.add_argument(
        "--masks_root",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\mmibc\ultrasound\masks",
    )

    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\runs\roi_fusion\roi_csv_generation",
    )

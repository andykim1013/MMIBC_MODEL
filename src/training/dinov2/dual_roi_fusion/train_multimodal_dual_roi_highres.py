...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--init_model_path",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\saved_models\best_multimodal_model.pth",
    )

    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"C:\Users\konyang\Desktop\MMIBC-main\runs\dual_roi_fusion\dual_roi_highres384_bs2_seed42_init_mmibc",
    )
